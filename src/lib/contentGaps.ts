...
export function offeringGapReport(universitySlug: string, programmeSlug: string): GapReport | null {
  ...
  const coverage: TopicCoverage[] = [
    ...
    cov("learningModel", info?.learningModel ?? uniInfo?.learningModel, "insights.learningModel"),
    cov("placement", offer.placement?.supportAvailable ? "yes" : offer.placement?.note, "offerings.placement"),
    cov("career", info?.career ?? p.whoIsItFor, "insights.career / programme.whoIsItFor"),
    ...
    cov("internships", info?.internships, "insights.internships"),
    cov("projects", info?.projects, "insights.projects"),
    cov("studentSupport", info?.studentSupport ?? uniInfo?.studentSupport, "insights.studentSupport"),
    ...
    cov("faqs", info?.faqs ?? uniInfo?.faqs, "insights.faqs"),
  ];
