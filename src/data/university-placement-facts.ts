...
export const universityPlacementFacts: Record<string, PlacementFacts> = {
  ...
  "lpu-online": {
    ...
    recruiters: [
      "Amazon", "Microsoft", "Google", "Wipro", "Infosys", "TCS", "Capgemini", "Cognizant",
      "HCL Technologies", "HDFC Bank", "ICICI Bank", "Kotak Mahindra Bank", "Axis Bank",
      "Bajaj Finserv", "Flipkart", "Reliance Retail", "Airtel", "Jio", "Deloitte", "EY",
      "KPMG", "Genpact", "LIC", "Max Life Insurance", "Paytm", "Tally", "IndiGo Airlines",
      "Maruti Suzuki", "Hero MotoCorp", "Asian Paints",
    ],
    support: [
  ...
  "manipal-university-jaipur": {
    ...
    recruiters: [
      "Capgemini", "Diageo", "Hexa Health", "Goldman Sachs", "HDFC Ergo", "Intellipaat",
      "Accenture", "IBM", "Deloitte", "LTIMindtree", "EY", "Allstate", "Infosys", "CarDekho",
      "Tata Communications", "Infinity Learn", "HP", "Bambino",
    ],
    support: [
    ...
    approvals: ["UGC-entitled online degrees", "NAAC A+", "AICTE-approved professional programmes", "WES recognition", "NBA", "AIU"],
  ...
  "nmims-online": {
    ...
    stats: [
      ...
      { label: "Online MBA package band", value: "INR 3.5–6 LPA, higher packages up to about INR 9 LPA" },
    ],
    recruiters: [
      "Medikabazaar", "Wockhardt", "ReachLocal", "Brimstone Creative", "Vaya", "Milk Basket",
      "Vivo India", "Bajaj Electricals", "HSBC", "Essel Packaging", "Shubham", "Max Stack Labs",
    ],
    support: [
  ...
  "jain-online": {
    ...
    recruiters: [
      "Accenture", "Nestlé", "Bosch", "Oracle", "Cognizant", "PwC", "Dell India", "Quess Corp",
      "EY", "Reliance Industries", "Flipkart", "Samsung", "Grant Thornton India", "TCS",
      "HP", "UnitedHealth Group", "IBM", "Visa", "JP Morgan", "Wipro", "KPMG", "Xchanging",
      "Lenovo", "Yamaha", "MTR Foods", "Zomato",
    ],
    support: ["Student career advisory and placement support team", "Recruiter drives across IT, BFSI, FMCG and consulting"],
  ...
  "dpu-online": {
    ...
    support: ["Role-wise career mapping for management specialisations", "Recruiter tie-ups across IT, manufacturing and services"],
  ...
  "shoolini-online": {
    ...
    stats: [],
    recruiters: [
      "Accenture", "Deloitte", "Ericsson", "ICICI Bank", "KPMG", "Nestlé", "Mercer", "Adani",
      "L'Oréal", "Bank of America", "Genpact", "American Express", "Grant Thornton",
      "Hindustan Unilever", "The Oberoi Group", "Mankind Pharma", "Airtel", "Yes Bank",
    ],
    support: ["Programme mentoring by senior industry professionals", "Global alumni network access for current learners"],
