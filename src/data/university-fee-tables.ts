  ...
  "sharda-online": {
    ...
    rows: [
      ...
      },
      {
        ...
        eligibility: "10+2 in any stream from a recognised board (Mathematics/Computer Science preferred)",
      },
      {
        course: "BA (Hons.)",
        specialisation: "General",
      ...
      },
      {
        ...
        eligibility: "Bachelor's degree in any discipline with a minimum 50% aggregate (45% for reserved categories)",
      },
      {
        course: "MCA",
        specialisation: "General",
        ...
        eligibility: "BCA / B.Sc (CS/IT) or a bachelor's degree with Mathematics at 10+2 or graduation level",
      },
      {
        course: "M.Com",
        specialisation: "General",
