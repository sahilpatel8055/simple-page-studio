...
export function defaultCourseContent(family: CourseFamily): CourseContent {
  ...
  return {
    ...
    audience: [
      {
        ...
        detail: `Study alongside a job, since sessions are recorded and assessments are scheduled around a semester calendar.`,
      },
      {
        title: "Fresh graduates",
        detail: `Add a recognised ${shortName} qualification while gaining early work experience or preparing for other examinations.`,
      },
      {
        title: "Career switchers",
        detail: `Build subject knowledge in a new domain without leaving current employment.`,
      },
      {
        title: "Learners outside metro cities",
        detail: `Access programmes from universities in other states without relocating.`,
      },
    ],
    eligibility: [
      {
        title: "Educational qualification",
        detail: `${entry} from a recognised institution, subject to the university's own requirement.`,
      },
      {
        title: "Minimum marks",
        detail:
          "University-specific. Several universities publish a minimum aggregate; others admit on qualification alone.",
      },
      {
        title: "Entrance examination",
        detail: family.entranceUniversities.length
          ? `Published by ${family.entranceUniversities.join(", ")} in our dataset. Most other listed universities admit directly.`
          : "Not published by the universities in our dataset for this course. Verify with the university before applying.",
      },
      {
        title: "Work experience",
        detail:
          "Not a general requirement for this course. Some universities ask for it only on executive or specialised variants.",
      },
    ],
    eligibilityNote:
    ...
    learningNote:
      "Not every university uses the same platform or session mix. Check the delivery model of the university you shortlist.",
    examPattern: defaultExamPattern(),
    examNote:
      "Assessment patterns, weightings and proctoring rules vary by university and can change between sessions.",
    specialisationGuide: [],
    careers: [],
...
export const defaultHowItWorks = (): Labelled[] => [
  {
    title: "Admission",
    detail:
      "You apply on the university's online admission portal, upload documents, and pay the first instalment once eligibility is confirmed.",
  },
  {
    title: "Learning platform (LMS)",
    detail:
      "The university issues login credentials to its learning platform, where the semester's content, schedule and submissions live.",
  },
  {
    title: "Live classes",
    detail:
      "Scheduled sessions with faculty, usually in the evening or on weekends, with doubt-clearing built in.",
  },
  {
    title: "Recorded lectures",
    detail:
      "Every session is normally recorded so you can study around work hours and revise before assessments.",
  },
  {
    title: "Assignments",
    detail:
      "Continuous assessment through assignments, quizzes and case work that counts toward internal marks.",
  },
  {
    title: "Examinations",
    detail:
      "Term-end examinations in the format the university specifies — commonly online and proctored.",
  },
  {
    title: "Project or capstone",
    detail: "Applied work in the final semesters, where the curriculum includes it.",
  },
  {
    title: "Degree award",
    detail:
      "The university awards the degree on completion, with the same nomenclature it uses for the on-campus programme.",
  },
];
...
export const defaultAdmissionSteps = (): Labelled[] => [
  {
    ...
    detail:
      "Confirm you meet the qualifying-degree and marks requirement for the specific university and admission year.",
  },
  {
    title: "Compare universities",
    detail:
      "Weigh entitlement status, total cost, specialisation availability and examination format side by side.",
  },
  {
    title: "Select the programme",
    detail:
      "Choose the course and specialisation; some universities lock the specialisation at admission.",
  },
  {
    title: "Submit the application",
    detail:
      "Register on the university's official admission portal and complete the application form.",
  },
  {
    title: "Upload documents",
    detail: "Provide marksheets, certificates, identity proof and photographs for verification.",
  },
  {
    title: "Complete admission",
    detail: "Pay the applicable instalment, receive the enrolment confirmation and LMS access.",
  },
];
...
export const defaultLearningFormat = (): Labelled[] => [
  ...
  {
    title: "Recorded lectures",
    detail: "On-demand access to every session for revision and schedule conflicts.",
  },
  {
    title: "Digital LMS",
    detail: "One place for the syllabus, schedule, submissions, results and announcements.",
  },
  {
    title: "Study material",
    detail: "E-books, reading lists, slides and case material issued by the university.",
  },
  {
    title: "Discussion forums",
    detail: "Peer and faculty discussion threads, where the university enables them.",
  },
...
export const defaultExamPattern = (): Labelled[] => [
  {
    ...
    detail: "Assignments, quizzes and participation contribute to the internal component.",
  },
  {
    title: "Term-end examination",
    detail: "End-of-semester examination covering the semester's subjects.",
  },
  {
    title: "Examination mode",
    detail: "Commonly online and remotely proctored; a few universities use designated centres.",
  },
  {
    title: "Projects and viva",
    detail: "Applied projects, and a viva where the curriculum includes one.",
  },
  {
    title: "Passing criteria",
    detail:
      "Set by the university, usually as a minimum aggregate across internal and term-end components.",
  },
];
...
export const defaultPlacementServices = (): Labelled[] => [
  {
    ...
    detail:
      "Access to a job board or referrals, where the university operates one for online learners.",
  },
  {
    title: "Resume support",
    detail: "Guidance on positioning experience and coursework for target roles.",
  },
  { title: "Mock interviews", detail: "Practice interviews and feedback, where offered." },
  {
    title: "Career counselling",
    detail: "One-to-one guidance on role and specialisation choices.",
  },
  { title: "Industry sessions", detail: "Guest lectures, webinars and networking events." },
  {
    title: "Internship support",
    detail: "Assistance for learners without work experience, where the university runs it.",
  },
];
...
export const defaultVsRegular = () => [
  ...
  {
    factor: "Working while studying",
    online: "Designed for it",
    regular: "Difficult in full-time programmes",
  },
  ...
  {
    factor: "Admission",
    online: "University specific",
    regular: "University specific, often entrance-led",
  },
  {
    factor: "Best suited to",
    online: "Professionals needing flexibility",
    regular: "Learners wanting a full-time campus experience",
  },
];

export const defaultVsDistance = () => [
  {
    factor: "Learning mode",
    online: "Structured digital delivery through an LMS",
    distance: "Self-study with printed or downloadable material",
  },
  {
    factor: "Live classes",
    online: "Scheduled live sessions in most programmes",
    distance: "Limited; contact sessions where offered",
  },
  { factor: "Recorded content", online: "Generally available", distance: "Not standard" },
  {
    factor: "Interaction",
    online: "Faculty and peer interaction online",
    distance: "Mostly independent",
  },
  {
    factor: "Examinations",
    online: "Often online and proctored",
    distance: "Frequently centre-based",
  },
  {
    factor: "Flexibility",
    online: "High, with a semester rhythm",
    distance: "Highest, with least structure",
  },
  {
    factor: "Student support",
    online: "Dedicated online support in most programmes",
    distance: "Varies widely",
  },
  {
    factor: "Rules",
    online: "University and programme specific",
    distance: "University and programme specific",
  },
];
...
export const defaultSelectionGuide = (): Labelled[] => [
  {
    title: "Verify recognition first",
    detail:
      "Confirm entitlement and approval status for the exact programme and year before comparing anything else.",
  },
  {
    title: "Compare total cost, not the headline fee",
    detail:
      "Add registration, examination, study material and technology charges to the tuition figure.",
  },
  {
    title: "Read the syllabus",
    detail:
      "Check that the subject list matches the role you are targeting, not just the degree name.",
  },
  {
    title: "Check specialisation availability",
    detail:
      "Confirm the specialisation you want is running this session, and whether you can change it later.",
  },
  {
    title: "Test the learning platform",
    detail: "Ask for a demo of the LMS, session schedule and how recordings are released.",
  },
  {
    title: "Understand the examination structure",
    detail: "Know the mode, proctoring rules, re-attempt policy and passing criteria.",
  },
  {
    title: "Ask about student support",
    detail:
      "Response times, academic mentors and escalation paths matter over a two- or three-year programme.",
  },
  {
    title: "Check career support in writing",
    detail: "Ask what the career service actually provides for online learners.",
  },
  {
    title: "Review refund and cancellation terms",
    detail: "Know what happens if you withdraw after the session starts.",
  },
  {
    title: "Confirm on the official source",
    detail: "Take the final decision from the university's own website and admission notification.",
  },
];
