...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/fevicon.png", sizes: "any" },
      { rel: "icon", href: "/fevicon.png", type: "image/png", sizes: "16x16" },
      { rel: "icon", href: "/fevicon.png", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/fevicon.png", type: "image/png", sizes: "192x192" },
      { rel: "icon", href: "/fevicon.png", type: "image/png", sizes: "512x512" },
      { rel: "shortcut icon", href: "/fevicon.png" },
      { rel: "apple-touch-icon", href: "/fevicon.png", sizes: "180x180" },
