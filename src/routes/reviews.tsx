...
const description =
  "Honest reviews from learners enrolled in online and distance programmes across India.";
const path = "/reviews";
      ...
      {reviews.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-border bg-secondary/40 p-8 text-center">
          <h2 className="font-display text-lg font-bold text-foreground">
            Learner reviews are coming soon
          </h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">
            We only publish reviews we can trace back to a real enrolled learner. Collection for the
            2026-27 session is in progress — meanwhile, compare universities on fees, approvals and
            curriculum.
          </p>
          <div className="mt-5 flex flex-wrap justify-center gap-3">
            <AppLink to="/compare/universities" className="btn btn-primary">
